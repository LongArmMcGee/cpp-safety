...
*  The National Security Agency (NSA) has released a new guidance document that provides recommendations for securing {cpp} code.
...
* Enforce with static analysis tools
